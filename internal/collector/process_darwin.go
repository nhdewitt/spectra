...
// CollectProcesses gathers the process list on Darwin.
...
// collectProcessRaw shells out to ps to gather process info.
func collectProcessRaw(ctx context.Context) ([]processRaw, int64, error) {
	totalMem := MemTotal()
	if totalMem == 0 {
