...
func TestCollectProxmox_NoPvesh(t *testing.T) {
	if hasCommand("pvesh") {
...
func TestCollectProxmox_Integration(t *testing.T) {
	if !hasCommand("pvesh") {
	...
	result, err := collectProxmox(ctx)
	if err != nil {
		t.Fatalf("collectProxmox failed: %v", err)
	}
...
func TestCollectProxmox_FiltersLocalNode(t *testing.T) {
	if !hasCommand("pvesh") {
		t.Skip("pvesh not available")
	}
...
func TestCollectProxmox_ContextCancel(t *testing.T) {
	if !hasCommand("pvesh") {
		t.Skip("pvesh not available")
	}
	...
	_, err := collectProxmox(ctx)
	// Should handle cancelled context gracefully
	t.Logf("collectProxmox with cancelled context: %v", err)
}

func TestCollectProxmox_Timeout(t *testing.T) {
	if !hasCommand("pvesh") {
		t.Skip("pvesh not available")
	}
	...
	t.Logf("collectProxmox with timeout: %v", err)
}
...
func BenchmarkCollectProxmox(b *testing.B) {
	if !hasCommand("pvesh") {
		b.Skip("pvesh not available")
	}
...
func BenchmarkCollectProxmox_ColdCache(b *testing.B) {
	if !hasCommand("pvesh") {
		b.Skip("pvesh not available")
	}
