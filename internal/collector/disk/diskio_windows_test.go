...
func TestCollectDiskIO_MultipleDrives(t *testing.T) {
	...
	getDrivePerf = func(idx uint32) (winapi.DiskPerformance, error) {
		...
		if callCount <= 3 {
			return winapi.DiskPerformance{BytesRead: baseRead, BytesWritten: baseWrite}, nil
		}
		return winapi.DiskPerformance{BytesRead: baseRead + 500, BytesWritten: baseWrite + 1000}, nil
	}
...
func TestCollectDiskIO_DriveError(t *testing.T) {
	...
	getDrivePerf = func(idx uint32) (winapi.DiskPerformance, error) {
		...
		if idx == 1 {
			return winapi.DiskPerformance{}, errors.New("drive not accessible")
		}
		if callCount <= 2 {
			return winapi.DiskPerformance{BytesRead: 1000}, nil
		}
		return winapi.DiskPerformance{BytesRead: 2000}, nil
	}
...
func TestCollectDiskIO_NewDriveAppears(t *testing.T) {
	...
	getDrivePerf = func(idx uint32) (winapi.DiskPerformance, error) {
		return winapi.DiskPerformance{BytesRead: int64(idx * 1000)}, nil
	}
