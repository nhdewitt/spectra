...
func TestCollect_ReturnsNilOnError(t *testing.T) {
...
func TestCollect_ContextNotUsed(t *testing.T) {
...
func TestCollect_ZeroCriticalTripPoint(t *testing.T) {
...
func TestCollect_ConsistentResults(t *testing.T) {
	...
	metrics1, _ := Collect(ctx)
	metrics2, _ := Collect(ctx)
