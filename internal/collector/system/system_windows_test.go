...
func TestCollect_UptimeIncreases(t *testing.T) {
	ctx := context.Background()

	data1, err := Collect(ctx)
	if err != nil {
...
func TestCollect_BootTimeStable(t *testing.T) {
	ctx := context.Background()
...
func TestCollect_ProcessCountReasonable(t *testing.T) {
	data, err := Collect(context.Background())
	if err != nil {
		t.Fatalf("Collect failed: %v", err)
	}
...
func TestCollect_ProcessCountMatchesSnapshot(t *testing.T) {
	data, err := Collect(context.Background())
	if err != nil {
		t.Fatalf("Collect failed: %v", err)
	}
...
func TestCollect_ContextCancel(t *testing.T) {
	...
	if err != nil {
		t.Logf("Collect with cancelled context returned error: %v", err)
	}
...
func TestCollect_AtLeastOneUser(t *testing.T) {
	data, err := Collect(context.Background())
	if err != nil {
		t.Fatalf("Collect failed: %v", err)
	}
...
func BenchmarkCollect_UptimeOnly(b *testing.B) {
...
func BenchmarkCollect_ProcessCount(b *testing.B) {
