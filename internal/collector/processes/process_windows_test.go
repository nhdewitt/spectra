...
func TestCollect_StatusDistribution(t *testing.T) {
	lastWinProcessStates = make(map[uint32]winProcessState)
...
func TestCollect_ThreadCounts(t *testing.T) {
	lastWinProcessStates = make(map[uint32]winProcessState)
...
func TestCollect_MemPercentRange(t *testing.T) {
	lastWinProcessStates = make(map[uint32]winProcessState)
...
func TestCollect_StateCleanup(t *testing.T) {
...
func TestCollect_ValidStatus(t *testing.T) {
	lastWinProcessStates = make(map[uint32]winProcessState)
...
func TestSystemThreadInformation_Size(t *testing.T) {
	size := unsafe.Sizeof(winapi.SystemThreadInformation{})
...
func TestSystemProcessInformation_Size(t *testing.T) {
	size := unsafe.Sizeof(winapi.SystemProcessInformation{})
...
func TestProcessState_Constants(t *testing.T) {
	tests := []struct {
		name  string
		state winapi.ProcessState
		value uint32
	}{
		{"StateInitialized", winapi.StateInitialized, 0},
		{"StateReady", winapi.StateReady, 1},
		{"StateRunning", winapi.StateRunning, 2},
		{"StateStandby", winapi.StateStandby, 3},
		{"StateTerminated", winapi.StateTerminated, 4},
		{"StateWaiting", winapi.StateWaiting, 5},
		{"StateTransition", winapi.StateTransition, 6},
		{"StateDeferredReady", winapi.StateDeferredReady, 7},
		{"StateGateWaitObsolete", winapi.StateGateWaitObsolete, 8},
		{"StateWaitingForProcessInSwap", winapi.StateWaitingForProcessInSwap, 9},
	}
...
func BenchmarkCollect_NoScheduler(b *testing.B) {
	lastWinProcessStates = make(map[uint32]winProcessState)
	ctx := context.Background()
