...
func readThermalZone(dir string) (*metrics.TemperatureMetric, error) {
...
func parseThermalZoneFrom(typeR, tempR, maxR io.Reader) (*metrics.TemperatureMetric, error) {
	// Sensor Name
	...
	return &metrics.TemperatureMetric{
		Sensor: name,
		Temp:   tempVal,
		Max:    maxVal,
	}, nil
